...
def process_weights_for_netuid(
    ...
    bittensor.logging.debug(f"netuid: {str(netuid)}")
    bittensor.logging.debug(f"subtensor: {str(subtensor)}")
    bittensor.logging.debug(f"metagraph: {str(metagraph)}")
    ...
    bittensor.logging.debug(f"quantile: {str(quantile)}")
    ...
    bittensor.logging.debug(f"max_exclude: {str(max_exclude)}")
    bittensor.logging.debug(f"exclude_quantile: {str(exclude_quantile)}")
    bittensor.logging.debug(f"lowest_quantile: {str(lowest_quantile)}")

    # Exclude all weights below the allowed quantile.
    non_zero_weight_uids = non_zero_weight_uids[lowest_quantile <= non_zero_weights]
    non_zero_weights = non_zero_weights[lowest_quantile <= non_zero_weights]
    bittensor.logging.debug(f"non_zero_weight_uids: {str(non_zero_weight_uids)}")
    bittensor.logging.debug(f"non_zero_weights: {str(non_zero_weights)}")

    # Normalize weights and return.
    normalized_weights = normalize_max_weight(
        x=non_zero_weights, limit=max_weight_limit
    )
    bittensor.logging.debug(f"final_weights: {str(normalized_weights)}")
